...
class connectStripeViewModel extends BaseViewModel {
  ...
  void init() {
    ...
    //   try {
    //     Dio dio = Dio();
    //     final url = 'https://watchemgrow.klickwash.net/api/create/payment';
    //     final result = await dio.get(url);
    //     log('i am here');
    //     print(result.toString());
    //     log('odsdjsidjsijddjdjsdjsdjsjdisjsjdsidjdid');
    //     final response = jsonDecode(result.toString());
    //     final ac_id = response['account']['id'];
       
    //     final uname =
    //         'sk_test_51JvIZ1Ey3DjpASZjmQpp61o9MDwfEnXHyZIbVE08CiJf3XxMKN93bOlu5MSxiw07yPJwX9kvDezuEugwSNZNkddy00ZCa33RpG';
    //     final pword = '';
