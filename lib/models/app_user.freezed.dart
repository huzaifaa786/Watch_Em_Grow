    ...
    return _then(_value.copyWith(
      ...
      purchases: purchases == freezed
          ...
          : purchases // ignore: cast_nullable_to_non_nullable
              as int,
      referrals: referrals == freezed
          ? _value.referrals
          : referrals // ignore: cast_nullable_to_non_nullable
              as int,
      earnByRef: earnByRef == freezed
          ? _value.earnByRef
          : earnByRef // ignore: cast_nullable_to_non_nullable
              as double,
      earnBySell: earnBySell == freezed
          ? _value.earnBySell
          : earnBySell // ignore: cast_nullable_to_non_nullable
              as double,
...
class _$_AppUser implements _AppUser {
  ...
  @override
  final double earnByRef;
  @JsonKey(defaultValue: 0.0)
  @override
  final double earnBySell;
  @JsonKey(defaultValue: '')
  @override
    ...
    return identical(this, other) ||
        (other is _AppUser &&
            ...
            (identical(other.referCode, referCode) ||
                const DeepCollectionEquality()
                    .equals(other.referCode, referCode)) &&
            ...
            (identical(other.referrals, referrals) ||
                const DeepCollectionEquality()
                    .equals(other.referrals, referrals)) &&
            (identical(other.earnByRef, earnByRef) ||
                const DeepCollectionEquality()
                    .equals(other.earnByRef, earnByRef)) &&
            (identical(other.earnBySell, earnBySell) ||
                const DeepCollectionEquality()
                    .equals(other.earnBySell, earnBySell)) &&
